...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Menerima data name, dan email dari LoginActivity
        ...
        TextView navUsername = (TextView) headerView.findViewById(R.id.tvName);
        navUsername.setText(getName);

        TextView navEmail = (TextView) headerView.findViewById(R.id.tvEmail);
        navEmail.setText(getEmail);

        Toast.makeText(getApplicationContext(), "Welcome, " + getName, Toast.LENGTH_SHORT).show();
